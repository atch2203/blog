...
---
Sometime during the middle of last week I decided to actually start playing CTFs, and I remember [dungwinux](https://dungwinux.github.io/) mentioned that [jellyc.tf](https://jellyc.tf/) was going on for 2 weeks and that it was good for beginners (aka me). 
...
check out [dungwinux](https://dungwinux.github.io/-blog/security/2024/06/24/jellyctf.html) for an unintended+easier solution
